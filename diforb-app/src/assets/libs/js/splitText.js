! function (D, u) {
	...
	function D(D, e, F, C) {
		var i, n, E, s, r, o, l, d, p = e.tag ? e.tag : e.span ? "span" : "div",
			...
			y = D.parentNode;
		for (y.insertBefore(m, D), m.textContent = D.nodeValue, y.removeChild(D), l = -1 !== (i = function getText(D) {
			var u = D.nodeType,
				e = "";
			if (1 === u || 9 === u || 11 === u) {
			...
			return e
		}(D = m)).indexOf("<"), !1 !== e.reduceWhiteSpace && (i = i.replace(b, " ").replace(S, "")), l && (i = i.split("<").join("{{LT}}")), r = i.length, n = (" " === i.charAt(0) ? f : "") + F(), E = 0; E < r; E++)
	...
	h.version = "3.3.0", e.SplitText = h, e.default = h;
